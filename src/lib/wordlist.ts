/**
 * Passphrase dictionary — unique words, ~10 bits of entropy per word.
 * Must not contain words from the common-password blacklist, otherwise
 * passphrases containing them would always be rejected.
 */
export const WORD_LIST: readonly string[] = [
  'abandon', 'ability', 'able', 'about', 'above', 'absorb', 'abstract', 'absurd',
  'abuse', 'accident', 'account', 'accuse', 'achieve', 'acid', 'acoustic',
  'acquire', 'across', 'action', 'actor', 'actual', 'adapt', 'add', 'addict',
  'address', 'adjust', 'admit', 'adult', 'advance', 'advice', 'aerial', 'affair',
  ...
  'carbon', 'card', 'care', 'career', 'careful', 'carrot', 'carry', 'cart',
  ...
  'circle', 'citizen', 'city', 'civil', 'claim', 'clamp', 'clarify', 'claw',
  ...
  'damp', 'dance', 'danger', 'daring', 'dark', 'dash', 'daughter', 'dawn',
  ...
  'drama', 'drastic', 'draw', 'dream', 'dress', 'drift', 'drill',
  ...
  'height', 'helmet', 'help', 'hen', 'hero', 'hidden', 'high',
  ...
  'level', 'liar', 'library', 'license', 'life', 'lift', 'light',
  ...
  'modify', 'mom', 'moment', 'monitor', 'monster', 'month', 'moon',
  ...
  'payment', 'peace', 'peach', 'peanut', 'pear', 'peasant', 'pelican', 'pen',
  ...
  'possible', 'post', 'potato', 'pottery', 'powder', 'power', 'practice',
  'praise', 'predict', 'prefer', 'prepare', 'present', 'pretty', 'prevent', 'price',
  'pride', 'primary', 'print', 'priority', 'prison', 'private', 'prize', 'problem',
  'process', 'produce', 'profit', 'program', 'project', 'promote', 'proof',   'prosper', 'protect', 'proud', 'provide', 'public', 'pudding', 'pull', 'pulp',
  ...
  'seven', 'shaft', 'shallow', 'share', 'shed', 'shell', 'sheriff',
  ...
  'weather', 'web', 'wedding', 'weekend', 'weird', 'west', 'wet',
